"undefined" == typeof window.define &&
  ...
  ($AJB.general.BeginStage = function () {
    ...
    function a(a) {
      ...
      var h = a.getElementsByClassName("button")[0],
        ...
        k = {
          show: function () {
            ;(a.style.display = ""), window.scrollTo()
          },
          hide: function () {
      ...
      var d,
        ...
        h = {
          ...
          switchStage: function (d, i) {
            var myWrp = document.getElementById("corewrapper")
            myWrp.style.display == "" || myWrp.style.display == "block"
              ? (myWrp.style.display = "none")
              : (myWrp.style.display = "block"),
              0 === d
                ? (h.point = [-b / 2, c / 2])
                : 1 === d &&
                  ((a.fillStyle = h.color),
  ...
  ($AJB.general.Scene = function () {
    ...
    function a(a, b, l, m) {
      ...
      function r() {
        "pass" !== A &&
          ((a.style.backgroundColor = "#18191a"),
          (A = "pass"),
          (v = +new Date()))
      }
      function s() {
        "fail" !== l &&
          ((a.style.backgroundColor = "#b03060"),
          (A = "fail"),
          (v = +new Date()))
      }
      function t() {
